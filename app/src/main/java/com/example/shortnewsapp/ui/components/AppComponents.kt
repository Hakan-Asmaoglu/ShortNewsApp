package com.example.shortnewsapp.com.example.shortnewsapp.ui.components
...
import com.example.shortnewsapp.R
import com.example.shortnewsapp.com.example.shortnewsapp.data.entity.Article
import com.example.shortnewsapp.com.example.shortnewsapp.data.entity.NewsResponse
import com.example.shortnewsapp.ui.theme.Purple40
...
fun AuthorDetailsComponent(authorName:String?, sourceName: String?) {
    Row (
        modifier = Modifier.fillMaxWidth().padding(start = 10.dp, end = 10.dp, bottom = 24.dp)
    ){
        authorName?.also {
            Text(text = it)
        }
